/**
 * QR Code Generator Library (Kazuhiko Arase / UTF-8 Enhanced)
 * Standalone, zero-dependency QR code matrix generator.
 */
(function() {
  function QR8bitByte(data) {
    ...
    this.parsedData = new Uint8Array(this.parsedData);
  }
  ...
  var QRPolynomial = function(num, shift) {
    ...
    for (var j = num.length - offset; j < this.num.length; j++) this.num[j] = 0;
  };
  ...
  var QRUtil = {
    ...
    getErrorFactoryPolynomial: function(errorCorrectionLength) {
  ...
  QRCodeModel.createData = function(typeNumber, errorCorrectionLevel, dataList) {
    ...
    if (buffer.length > totalDataCount * 8) {
      throw new Error('Code length overflow. Data is too long for QR Code (' + buffer.length + ' > ' + totalDataCount * 8 + ' bits).');
    }
  ...
  QRCodeModel.createBytes = function(buffer, rsBlocks) {
    ...
    for (var r = 0; r < rsBlocks.length; r++) {
      ...
      offset += dcCount;
      var rsPoly = QRUtil.getErrorFactoryPolynomial(ecCount);
  ...
  window.QRCodeGenerator = {
    ...
    create: function(text, errorCorrectionLevel, typeNumber) {
      if (typeof errorCorrectionLevel === 'undefined') {
        errorCorrectionLevel = this.CorrectLevel.M;
      }
      typeNumber = typeNumber || 0;
      var qr = new QRCodeModel(typeNumber, errorCorrectionLevel);
      qr.addData(text);
      qr.make();
      return qr;
    }
